...
daysAgo: 'd ago',
  ...
  enterTajikWord: "Enter Tajik word",
  enterEnglishTranslation: "Enter English translation",
  enterRussianTranslation: "Enter Russian translation",
  enterEnglishExplanation: "Enter English explanation",
  enterRussianExplanation: "Enter Russian explanation",
  enterExamples: "Enter examples",
  addWord: "Add Word",
  adding: "Adding...",
  wordAddedSuccessfully: "Word added successfully!",
  failedToAddWord: "Failed to add word",
  fillRequiredFields: "Please fill in all required fields",
  completeLevelsToSeeWords: "Complete levels to see studied words",
  noWordsStudiedYet: "No words studied yet",
...
daysAgo: ' дн. назад',
    ...
    tajikWord: 'Таджикское слово',
    englishTranslation: 'Английский перевод',
    russianTranslation: 'Русский перевод',
    englishExplanation: 'Английское объяснение',
    russianExplanation: 'Русское объяснение',
    enterTajikWord: 'Введите таджикское слово',
    enterEnglishTranslation: 'Введите английский перевод',
    enterRussianTranslation: 'Введите русский перевод',
    enterEnglishExplanation: 'Введите английское объяснение',
    enterRussianExplanation: 'Введите русское объяснение',
    enterExamples: 'Введите примеры',
    addWord: 'Добавить слово',
    adding: 'Добавление...',
    wordAddedSuccessfully: 'Слово успешно добавлено!',
    failedToAddWord: 'Не удалось добавить слово',
    fillRequiredFields: 'Пожалуйста, заполните все обязательные поля',
    completeLevelsToSeeWords: 'Завершите уровни, чтобы увидеть изученные слова',
    noWordsStudiedYet: 'Пока нет изученных слов',
  }
};
