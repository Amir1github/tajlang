...
export default function LearnScreen() {
  ...
  async function fetchLevels() {
    try {
      const { data, error } = await supabase
        .from('levels')
        .select('*, en_title, ru_title, ru_description') // Добавляем выборку en_title и ru_title
        .order('order_number');
  ...
  // Функция для получения локализованного названия уровня
    ...
    const cardContent = (
      <View style={[
        ...
        <View style={styles.levelContent}>
          ...
          <Text style={[styles.levelDescription, { color: colors.textSecondary }]}>{getLevelDescription(item)}</Text>
          <Text style={[
            styles.statusText,
